 ...
 */
export namespace CreateNpcInput {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: CreateNpcInput): void {
    CreateNpcInput.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): CreateNpcInput {
    return CreateNpcInput.getTypeScriptAlgebraicType().deserialize(reader);
  }
