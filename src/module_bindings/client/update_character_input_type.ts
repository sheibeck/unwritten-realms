 ...
 */
export namespace UpdateCharacterInput {
  /**
  ...
  */
  export function getTypeScriptAlgebraicType(): AlgebraicType {
    return AlgebraicType.createProductType([
      ...
      new ProductTypeElement("currentLocation", AlgebraicType.createOptionType(AlgebraicType.createStringType())),
      ...
      new ProductTypeElement("professionAbilities", AlgebraicType.createOptionType(AlgebraicType.createStringType())),
      new ProductTypeElement("armorType", AlgebraicType.createOptionType(AlgebraicType.createStringType())),
  ...
  export function serialize(writer: BinaryWriter, value: UpdateCharacterInput): void {
    UpdateCharacterInput.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): UpdateCharacterInput {
    return UpdateCharacterInput.getTypeScriptAlgebraicType().deserialize(reader);
  }
